...
class articulation_collector:
  def __init__(self):
    ...
    self.pose_pub = rospy.Publisher('track', TrackMsg, queue_size = 1)
    self.object_pub = rospy.Publisher('object', ArticulatedObjectMsg, queue_size = 1)
    rospy.Subscriber("/camera/pose_array", PoseArray, self.callback,queue_size=3)
    self.object_parts = []
